...
@section('content')
  <div class="container-fluid" style="margin-top: 200px;">
    <h1 class="text-center">@if(canEditLang() && checkRequestOnEdit()) <editor_block data-name='До старта NFT мркетплейса' contenteditable="true">{{ __('До старта NFT мркетплейса') }}</editor_block> @else {{ __('До старта NFT мркетплейса') }} @endif</h1>
