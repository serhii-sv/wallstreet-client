...
<tr>
    ...
    <td>
        <span class="badge rounded-pill pill-badge-info" style="color: white;font-size: 16px;">{{ cache()->remember('user_ref_login.'.$self->id, now()->addHours(3), function() { return $self->partner->login ?? 'undefined'; }) }}</span>
    </td>
    <td>
                        <span class="label">
