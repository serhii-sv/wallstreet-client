...
@section('content')
  ...
  <div class="container-fluid">
    <div class="row second-chart-list third-news-update" style="margin-top:100px;">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="card-body">
              ...
              <ref></ref>
              <script src="{{ asset('accountPanel/js/d3/d3.min.js') }}"></script>
              <script>
                ...
                d3.json("{{route('accountPanel.referrals.reftree',['id'=>$user->id])}}", function (error, flare) {
