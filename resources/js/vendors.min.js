    ...
    return _inherits(n, Component), _createClass(n, [{
      ...
      key: "_calculatePositioning", value: function () {
        ...
        var n = this.$origin.outerWidth(), s = this.$origin.outerHeight(),
            ...
            _ = o + s / 2 - g / 2, y = a + n / 2 - m / 2, k = t ? "fixed" : "absolute", b = f ? m : m / 2 + n,
            w = g / 2, C = p ? g / 2 : 0, E = u && !f ? m / 2 - n : 0, O = n, x = v ? "bottom" : "top", L = 2 * n,
            T = L, $ = g / 2 - T / 2, B = m / 2 - L / 2, D = {};
...
!function () {
  ...
  function s(u, e, d) {
    var t = (e = "string" == typeof e ? e : u.getAttribute("data-line")).replace(/\s+/g, "").split(","),
        c = +u.getAttribute("data-line-offset") || 0, f = (n() ? parseInt : parseFloat)(getComputedStyle(u).lineHeight),
        h = l(u, "line-numbers"), p = h ? u : u.querySelector("code") || u, m = [];
      ...
      key: "translate", value: function (e, n) {
        ...
        if (b && h && ("string" != typeof h && "boolean" != typeof h && "number" != typeof h) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(y) < 0 && ("string" != typeof m || "[object Array]" !== y)) {
          ...
          if (j || R || N) {
            ...
            var C = [], E = this.languageUtils.getFallbackCodes(this.options.fallbackLng, n.lng || this.language);
  ...
  var N = function () {
    ...
    return a(e, [{
      ...
      key: "toResolveHierarchy", value: function (e, t) {
        var n = this, r = this.getFallbackCodes(t || this.options.fallbackLng || [], e), o = [], i = function (e) {
  ...
  var T = function (e) {
    ...
    return f(t, d), a(t, [{
      ...
      key: "loadOne", value: function (e) {
        var t = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", r = A(e.split("|"), 2),
            o = r[0], i = r[1];
