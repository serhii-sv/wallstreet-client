(function ($) {
  ...
  function toggleFullScreen() {
    if (document.fullScreenElement && document.fullScreenElement !== null || !document.mozFullScreen && !document.webkitIsFullScreen) {
      $(".toggle-fullscreen").find(".feather-maximize").addClass('d-none');
      $(".toggle-fullscreen").find(".feather-minimize").removeClass('d-none');
      ...
      $(".toggle-fullscreen").find(".feather-maximize").removeClass('d-none');
      $(".toggle-fullscreen").find(".feather-minimize").addClass('d-none');
