...
$('<div class="customizer-links"><div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical"> ' +
    ...
    '</ul><h6>Light layout</h6><ul class="layout-grid customizer-color"><li class="color-layout" data-attr="color-1" data-primary="#1500FF" data-secondary="#f73164"><div></div></li><li class="color-layout" data-attr="color-2" data-primary="#4831D4" data-secondary="#ea2087"><div></div></li><li class="color-layout" data-attr="color-3" data-primary="#d64dcf" data-secondary="#8e24aa"><div></div></li><li class="color-layout" data-attr="color-4" data-primary="#4c2fbf" data-secondary="#2e9de4"><div></div></li><li class="color-layout" data-attr="color-5" data-primary="#7c4dff" data-secondary="#7b1fa2"><div></div></li><li class="color-layout" data-attr="color-6" data-primary="#3949ab" data-secondary="#4fc3f7"><div></div></li></ul><h6 class="">Dark Layout</h6><ul class="layout-grid customizer-color dark"><li class="color-layout" data-attr="color-1" data-primary="#4466f2" data-secondary="#1ea6ec"><div></div></li><li class="color-layout" data-attr="color-2" data-primary="#4831D4" data-secondary="#ea2087"><div></div></li><li class="color-layout" data-attr="color-3" data-primary="#d64dcf" data-secondary="#8e24aa"><div></div></li><li class="color-layout" data-attr="color-4" data-primary="#4c2fbf" data-secondary="#2e9de4"><div></div></li><li class="color-layout" data-attr="color-5" data-primary="#7c4dff" data-secondary="#7b1fa2"><div></div></li><li class="color-layout" data-attr="color-6" data-primary="#3949ab" data-secondary="#4fc3f7"><div></div></li></ul><h6 class="">Mix Layout</h6><ul class="layout-grid customizer-mix"><li class="color-layout active" data-attr="light-only"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-light sidebar"></li><li class="bg-light body"></li></ul></div></li><li class="color-layout" data-attr="dark-sidebar"><div class="header bg-light"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-dark sidebar"></li><li class="bg-light body"></li></ul></div></li><li class="color-layout" data-attr="dark-only"><div class="header bg-dark"><ul><li></li><li></li><li></li></ul></div><div class="body"><ul><li class="bg-dark sidebar"></li><li class="bg-dark body"></li></ul></div></li></ul></div><div class="tab-pane fade" id="c-pills-layouts" role="tabpanel" aria-labelledby="c-pills-layouts-tab"><ul class="sidebar-type layout-grid layout-types"><li data-attr="compact-sidebar"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/dubai.jpg" class="img-fluid" alt="" /></a><h6>Dubai</h6></div></li><li data-attr="material-layout"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/los.jpg" class="img-fluid" alt="" /></a><h6>Los Angeles</h6></div></li><li data-attr="dark-sidebar"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/paris.jpg" class="img-fluid" alt="" /></a><h6>Paris</h6></div></li><li data-attr="compact-wrap"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/tokyo.jpg" class="img-fluid" alt="" /></a><h6>Tokyo</h6></div></li><li data-attr="compact-small"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/moscow.jpg" class="img-fluid" alt="" /></a><h6>Moscow</h6></div></li><li data-attr="enterprice-type"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/singapore.jpg" class="img-fluid" alt="" /></a><h6>Singapore</h6></div></li><li data-attr="box-layout" class="box-layout"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/newyork.jpg" class="img-fluid" alt="" /></a><h6>New York</h6></div></li><li data-attr="advance-type"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/barc.jpg" class="img-fluid" alt="" /></a><h6>Barcelona</h6></div></li><li data-attr="color-sidebar"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/madrid.jpg" class="img-fluid" alt="" /></a><h6>Madrid</h6></div></li><li data-attr="material-icon"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/romo.jpg" class="img-fluid" alt="" /></a><h6>Rome</h6></div></li><li data-attr="modern-layout"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/seoul.jpg" class="img-fluid" alt="" /></a><h6>Seoul</h6></div></li><li class="only-body" data-attr="default-body"><div class="layout-img"> <a href="javascript:void(0)">' +
    '<img src="../accountPanel/images/landing/layout-images/london.jpg" class="img-fluid" alt="" /></a><h6>London</h6></div></li></ul></div></div></div></div>').appendTo($('body'));
(function () {
})();
//live customizer js
