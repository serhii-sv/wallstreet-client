...
use App\Jobs\TaskCheck\Youtube\YoutubeChannelSubscriptionJob;
use App\Models\UserTasks\UserTaskActions;
use Illuminate\Console\Command;

class YoutubeChannelSubscriptionCommand extends Command
{
    /** @var string|null */
     ...
     * @var string
     */
    protected $signature = 'task_check:youtube:channel_subscription {userTaskActionId?}';
    ...
    public function handle()
    {
        ...
        YoutubeChannelSubscriptionJob::dispatch($userTaskAction)->onQueue(getSupervisorName().'-high')->delay(now());
    }
}
