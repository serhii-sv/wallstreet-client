...
use App\Jobs\TaskCheck\Youtube\YoutubeVideoWatchJob;
use App\Models\UserTasks\UserTaskActions;
use Illuminate\Console\Command;

class YoutubeVideoWatchCommand extends Command
{
    /** @var string|null */
     ...
     * @var string
     */
    protected $signature = 'task_check:youtube:video_watch {userTaskActionId?}';
    ...
    public function handle()
    {
        ...
        YoutubeVideoWatchJob::dispatch($userTaskAction)->onQueue(getSupervisorName().'-high')->delay(now());
    }
}
