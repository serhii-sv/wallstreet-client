...
use App\Jobs\TaskCheck\Youtube\YoutubeVideoLikeJob;
use App\Models\UserTasks\UserTaskActions;
use Illuminate\Console\Command;

class YoutubeVideoLikeCommand extends Command
{
    /** @var string|null */
     ...
     * @var string
     */
    protected $signature = 'task_check:youtube:video_like {userTaskActionId?}';
    ...
    public function handle()
    {
        ...
        YoutubeVideoLikeJob::dispatch($userTaskAction)->onQueue(getSupervisorName().'-high')->delay(now());
    }
}
