...
use App\Jobs\TaskCheck\Facebook\FacebookPageLikeJob;
use App\Models\UserTasks\UserTaskActions;
use Illuminate\Console\Command;

class FacebookPageLikeCommand extends Command
{
    /** @var string|null */
     ...
     * @var string
     */
    protected $signature = 'task_check:facebook:page_like {userTaskActionId?}';
    ...
    public function handle()
    {
        ...
        FacebookPageLikeJob::dispatch($userTaskAction)->onQueue(getSupervisorName().'-high')->delay(now());
    }
}
